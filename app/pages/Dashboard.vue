...
<template>
  <div class="space-y-8 py-6">
    ...
    <section>
      <h2 class="text-lg font-semibold mb-3">{{ t('home.upcomingEvents') }}</h2>
      <ul class="space-y-2">
        <li
    ...
    <section>
      <h2 class="text-lg font-semibold mb-3">{{ t('home.inboxSummary') }}</h2>
      <div class="flex flex-wrap gap-2">
        <NuxtLink
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <section>
        <h2 class="text-lg font-semibold mb-3">{{ t('home.todosPromo') }}</h2>
        <ul class="space-y-2">
          <li
      ...
      <section>
        <h2 class="text-lg font-semibold mb-3">{{ t('home.todosLogistics') }}</h2>
        <ul class="space-y-2">
          <li
          ...
          >
            ...
            <span class="text-gray-500 shrink-0">{{ t(`status.logistics.${l.status}`) }}</span>
          </li>
    ...
    <section>
      <h2 class="text-lg font-semibold mb-3">{{ t('home.modules') }}</h2>
